<%@ Page Title="" Language="C#" MasterPageFile="~/Master1.Master" AutoEventWireup="true" CodeBehind="MusteriGuncelle.aspx.cs" Inherits="Test.MusteriGuncelle" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    ...
    <div>
    <h1>Müşteri Bilgisi Güncelle</h1>
        </div>
    <br />
    ...
    <form id="Form1" runat="server">
        ...
        <div class="forum-group">
            ...
            <asp:Label for="TxtMusteriEposta" runat="server">Musteri E-postası:</asp:Label>
